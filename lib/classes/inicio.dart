...
class _Iniciar extends State<Inicio> {
  ...
  _sup(tamano) {
    ...
    return Container(
      ...
      child: Column(
        children: [_cajaArriba(tamano), _cajaAbajo(tamano)],
      ),
    );
  }
  ...
  _right0(nTam) {
    return Container(
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadiusDirectional.only(
            topEnd: Radius.circular(30.0), bottomEnd: Radius.circular(30.0)),
        color: Colors.blue,
      ),
      alignment: Alignment.center,
      child: Text(
